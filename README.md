...
- [ForgeOS Control and generalized real-project Builder](https://github.com/Eddienews/forgeos-lite-trueforge/pull/7): adds the loopback Control interface, sealed candidate preview, bounded multi-file Builder tools, runtime-value anti-hardcoding evidence, and a distinct mission smoke proof. Qodo's initial review found seven valid correctness and reliability issues covering executable mission criteria, retained-resource cleanup, cleanup retry, fixture and preview rollback, validation-failure presentation, and tracked file deletion. The corrections add focused regression coverage without broadening Builder or application authority. CI and Qodo final-head review remain mandatory before this pull request can reach the human merge gate.
