...
- [Phase 5 — demo workflow and submission readiness](https://github.com/Eddienews/forgeos-lite-trueforge/pull/6): this PR adds the presentation-only demo, deterministic fixture, preflight, documentation, and repository checks. Qodo findings and final-head status must be recorded here before human merge approval; no clean result is claimed in advance.
